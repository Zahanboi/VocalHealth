// import { Mic, Star, BookOpen, bot, ArrowRight, Activity, Heart, Shield, Zap, Award,Target,
//   BrainCircuit,
//   HandCoins,
//   LineChart,
//   Languages
...
//                 title: "Cost-Effective Help",
//                 desc: "Provides therapy-like support at a fraction of the cost—no expensive sessions.",
  ...
  return (
    <div className="font-inter bg-gradient-to-br from-blue-50 via-white to-purple-50 min-h-screen text-gray-900 relative overflow-hidden">
      ...
      <header className="bg-white/90 backdrop-blur-md shadow-xl py-6 px-8 flex justify-between items-center rounded-b-3xl border-b border-blue-100 relative z-10">
        ...
        <nav className="flex gap-8 text-base font-semibold">
          <Link to="/" className="text-blue-600 hover:underline underline-offset-4 transition">
            Home
          </Link>
          {user ? (
            <>
              ...
              <Link to="/exercises" className="text-gray-700 hover:text-blue-600 transition">
                Exercises
              </Link> */}
              <button
                onClick={() => {
            ...
            <Link to="/auth" className="text-gray-700 hover:text-blue-600 transition">
              Login
            </Link>
          )}
        </nav>
          ...
          {[
            {
              ...
              title: "Stuttering-Specific Support",
              desc: "Exercises designed specifically for stuttering — not just general speech or mindfulness routines.",
              color: "from-pink-400 to-red-400",
            },
            {
              icon: <BrainCircuit className="text-purple-500" size={32} />,
              title: "AI Feedback Analysis",
              desc: "Get AI analysis and live feedback on the voice sample uploaded by user.",
              color: "from-purple-400 to-indigo-500",
            },
            {
              icon: <HandCoins className="text-green-500" size={32} />,
              title: "Cost-Effective Help",
              desc: "Therapy-like support at a fraction of the cost — no expensive sessions.",
              color: "from-green-400 to-emerald-400",
            },
            {
              icon: <LineChart className="text-yellow-500" size={32} />,
              title: "Smart Progress Tracking",
              desc: "Tracks fluency improvement over time with real-time voice data and visual reports.",
              color: "from-yellow-400 to-orange-400",
            },
            {
              icon: <Languages className="text-blue-500" size={32} />,
              title: "Language Inclusivity",
              desc: "Support for regional languages to make therapy more accessible and relatable.",
              color: "from-blue-400 to-cyan-400",
            },
            {
              icon: <Award className="text-pink-500" size={32} />,
              title: "Coming Soon: Achievements",
              desc: "Gamified journey with milestones and motivational badges for consistent users.",
